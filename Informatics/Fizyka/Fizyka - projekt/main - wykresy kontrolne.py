...
class main(QtWidgets.QWidget):
    ...
    #Sprawdzanie kolizji pomiędzy atomami ma złożoność wykładniczą
    #Ten algorytm nie poprawia klasy złożoności
    #Jedynie sprawia, że jest wykonywanych potencjalnie mniej operacji
    #Bo zamienia liczbę operacji z c_1n! na c_2m!, gdzie c_2 > c_1, ale m < n, co zazwyczaj się opłaca
    ...
    def checkSectors(self):
        ...
        for i in range(liczba):
            ...
            for sy in range(liczbaSektorowMinus1):
                if (xR > sektoryTreshold[liczbaSektorowMinus1]) and (yR > sektoryTreshold[sy]) and (y < sektoryTreshold[sy+1]):
    ...
    def createPlots(self):
        ...
        if (tick == 5000):
            ...
            result1_err = [0 for i in range(7)]
            result2_err = [0 for i in range(7)]
            for i in range(7):
                avg1 = 0.0
                avg2 = 0.0
